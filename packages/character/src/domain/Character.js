...
var IdGenerator_1 = require("../../../cqrs-common/src/utils/IdGenerator");
...
var Character = /** @class */ (function () {
    function Character(events) {
        this.projection = new common_2.DecisionProjection();
        this.projection
...
function createCharacter(publishEvent, userId, name, className) {
    var characterId = new CharacterId(IdGenerator_1.default.generate());
