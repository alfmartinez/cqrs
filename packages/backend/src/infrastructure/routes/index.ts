...
export class RouteConfigurator {
    ...
    private characterRouteConfigurator: CharacterRouteConfigurator;
    ...
    constructor() {
        ...
        this.characterRouteConfigurator = new CharacterRouteConfigurator(this.store, this.eventPublisher);
    }
    ...
    public configure(router: Router) {
        ...
        this.characterRouteConfigurator.configureRoutes(router, secure);
    }
}
